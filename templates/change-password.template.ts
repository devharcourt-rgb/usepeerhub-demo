       ...
       <div class="header">
        ...
        <h1>Password Changed</h1>
          ...
          <main>
             ...
             You have successfully changed your password on PeerHub.
              </p>
    
  
              <p>If you did not initiate this request, please send us an email at <b>support@PeerHub.com</b>
    
                  <p>
                      Best Regards,<br>Team PeerHub
                  </p>
          <div class="footer">
              <hr />
              <p>Follow us on:</p>
