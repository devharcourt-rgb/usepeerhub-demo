export const forgotTransactionPinEmailTemplate = ({
  firstName,
  lastName,
  otp,
  ...
  return `<!DOCTYPE html>
    ...
    <div class="header">
     <img id="logo" src="https://res.cloudinary.com/dgn6edv1k/image/upload/v1730034876/social_2_pyfqro.jpg" width="50" height="50"/>
        <h1>Forgot Transaction Pin</h1>
    </div>
    <div class="content">
        <p>Hello ${firstName},</p>
     <p>We received a request to reset your transaction pin for your ${companyName} account.
