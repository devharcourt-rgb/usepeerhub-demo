export const electricityTopupNotificationTemplate = () => {
  return `<!DOCTYPE html>
      <html lang="en">
      <head>
          <meta charset="UTF-8">
       ...
       <img id="logo" src="https://res.cloudinary.com/dgn6edv1k/image/upload/v1789469138/logo-blue_twd5mt.svg" width="50" height="50"/>
        <h1>Credit Alert</h1>
          ...
          <main class="content">
              <p>Hello Admin,</p>
              <p>
                This is to notify you that the float for NelloBytes (our third party provider) is low. Please fund the float to ensure uninterrupted service.
